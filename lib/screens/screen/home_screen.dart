...
class _HomeScreen extends StatelessWidget {
                      ...
                      Expanded(
                        child: GridView.count(
                          ...
                          children: [
                            ...
                            serviceWidget(context, 'document.png', 'Article\n'),
                            serviceWidget(context,
                                'report_black.png', 'Ticket\n'),
                            // serviceWidget(context,'more.png', 'Test\n'),
                          ],
                        ),
                      ),
                    ],
  ...
  Column serviceWidget(BuildContext context, String img, String screenName) {
    return Column(
      children: [
        Expanded(
          child: InkWell(
            onTap: () {
              //change screen by called provider
              context.read<HomeProvider>().changeScreen(screenName);
            },
            child: Container(
    ...
    return Alert(
      ...
      buttons: [
        ...
        DialogButton(
          ...
          color: Colors.green,
          onPressed: () async {
            context.read<HomeProvider>().confirmCheckIn(
