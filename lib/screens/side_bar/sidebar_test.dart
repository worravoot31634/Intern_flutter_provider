...
class SideBarTest extends StatelessWidget {
  ...
  SideBarTest({this.screen});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: _SideBarTest(screen: screen),
    );
  }
}

class _SideBarTest extends StatefulWidget {
  final Widget screen;

  _SideBarTest({this.screen});

  @override
  _SideBarStateTest createState() => _SideBarStateTest(screen: screen);
}

class _SideBarStateTest extends State<_SideBarTest>
                  ...
                  children: [
                    InkWell(
                      onTap: (){
                        ...
                        child:
                            navigatorTitle("Home", Icons.home_outlined, true)),
                    InkWell(
                        onTap: (){
                    ...
                    InkWell(
                        ...
                        child:
                            navigatorTitle("Help", Icons.help_outlined, false)),
                  ],
                ),
              ),
              InkWell(
                onTap: () {
                  print('logout');
                  //TODO: clear all SharedPref and clear other cache
                  Get.toNamed('/');
                },
                child: Container(
